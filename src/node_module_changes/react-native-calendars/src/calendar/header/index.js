                ...
                <View style={this.style.header}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        <View style={{alignItems:'center',justifyContent:'center'}}>
                            <Text multiline={true} style={this.style.monthText} accessibilityTraits='header'>
                                {this.props.month.toString(this.props.monthFormat).toUpperCase()}
                            </Text>
                            <Text multiline={true} style={[this.style.monthText, {fontSize: 20}]} accessibilityTraits='header'>
